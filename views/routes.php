...
<html>
  ...
  <body>
    <div class="body">
      ...
      <br/>
      <h4>
        مسار ملف الموجهات في موقعك موجود  في :
        <br/>
        Kernel/Routes/routes.php
        <br/>
        نضيف اي موجهات نريدها :
...
return $this->add([
  ...
  '/getUser/id'=> "UserController.getData|GET"
]);
        </code>
        </pre>
      ...
      <div class="body">
        ...
        المعامل الاول هو عنوان الموجه أو الرابط .
        <br/>
        المعامل الثاني : المعامل الاول من المعامل الثاني هو اسم المتحكم و تفصل بينه و بين اسم الدالة التي تتحكم با هذا الموجه هي علامة "."
        <br/>
        المعامل الثالث من المعامل الثاني هو نوع الطلب ويمكن تحديده با GET POST ALL
        <br/>
        <strong>ALL : </strong> تعني استقبال جميع انواع الطلبات .
