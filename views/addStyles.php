...
<html>
  ...
  <body>
    <div class="body">
      ...
      <h1>تضمين ملفات الستايل و الجافاسكريبت في المستعرض :</h1>
      <br/>
      <h4>
        الشرح السابق عن تمرير بيانات من المتحكم الى المستعرض
        <br/>
        <br/>
        توضع ملفات الستايل و الجافاسكريبت و الصور ... في مجلد views
        <br/>
        او با امكانك انشاء مجلد في المسار الرئيسي للمشروع
        <br/>
        <div class="code" style=" direction:ltr; max-width:60%; padding-left:20%; padding-right:20%;">

          <pre>
            <code class="html">
              link rel="stylesheet" href="/views/style.css" media="screen" title="no title" charset="utf-8"
              <br/>
              img src="/views/img.jpg" alt=""
          </code>
          </pre>
  </div>
</h4>
