...
<html>
  ...
  <body>
    <div class="body">
      ...
      <br/>
      <br/>
      <h1>تخصيص تنفيذ الاستعلام</h1>
      <br/>
      <h4>
        يمكنك ان لا تتقيد با الدوال الموجودة في الكلاس الخاص با التعامل مع قواعد البيانات , يمكنك ان تنفذ استعلاماتك الخاصة
        <br/>
        سا نأخذ هذا المثال :
      </h4>
    </div>
...
class HomeController extends BaseController {
  ...
  public function index() {
      print_r($this->Database->runSql("SELECT * FROM users ORDER BY id desc Limit 3"));
  }
