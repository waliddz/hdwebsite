...
<html>
  ...
  <body>
    <div class="body">
      ...
      <h1>الروابط التشعبية :</h1>
      <br/>
      <h4>

      يمكن اعادة توجيه مستخدم الى صفحة اخرى عن طريق الضغظ على رابط تشعبي .
      <br/>
      <br/>
      مثال :
      <br/>
      نريد توجيه مستخدم من الصفحة الرئيسية الى صفحة تسجيل الدخول
      <br/>
      المتحكم الخاص با الصفحة الرئيسية هو HomeController .
      <br/>
      و المستعرض هو home .
      <br/>
      </h4>
