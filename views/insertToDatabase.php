...
<html>
  ...
  <body>
    <div class="body">
      ...
      <br/>
      <br/>
      <h1>ادخال البيانات الى قاعدة بيانات</h1>
      <br/>
      <h4>
        في الشرح السابق شرحنا اخراج البيانات من قاعدة البيانات
        <br/>
        سا نأخذ هذا المثال :
      </h4>
    </div>
...
class HomeController extends BaseController {
  ...
  public function index() {
    if($this->Database->save("users",['username','password'],['php7','php7Password'])) {
      echo "All done";
    }
  }
    ...
    <div class="body">
      <h4>
        <center>
          <br/>
          المعامل الاول من دالة save هو اسم الجدول
          <br/>
          المعامل الثاني هو عبارة عن مصفوفة و تمثل حقول هذا الجدول
          <br/>
          المعامل الثالث هو عبارة عن مصفوفة و تمثل القيم التي نريد ادخالها
        </center>
      </h4>
    </div>
  </body>
